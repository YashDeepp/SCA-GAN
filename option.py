...
def init():
    ...
    parser.add_argument('--root', type=str, default='./sketches', help='image source folder')
    ...
    # parser.add_argument('--infofile', default=['/home/lixiang/dataset/spade/files/list_train.txt', '/home/lixiang/dataset/spade/files/list_test.txt'], help='infofile')
    ...
    parser.add_argument("--model_dir", type=str, default="/home/lixiang/lx/scagan/pre_trained_models",
                        help="directory for vgg, if model is not present in the directory it is downloaded")
    parser.add_argument('--styleParam', type=float, default=5.0, help='')
    parser.add_argument('--model_vgg', type=str, default='/home/lixiang/lx/scagan/pre_trained_models/vgg.model', help='vgg model')
